...
var call_func_file = path.join(curr_path, 'result', args[0], 'understand/call_func_pair.json');
var call_func_info_file = path.join(curr_path, 'result', args[0], 'call_func_info/call_func_info.json');

var call_func_info = JSON.parse(fs.readFileSync(call_func_file));
...
fs.writeFileSync(call_func_info_file, JSON.stringify(call_func_info), 'utf-8');

// 获取文件函数定义对应的注释以及参数
function extractFuncInfo(file) {
